#Simplied version of https://stackoverflow.com/questions/52623799/use-paho-mqtt-with-pyqt
# There is a pip-installable library https://github.com/eyllanesc/qtmqtt
...
class MqttClient(QtCore.QObject):
    ...
    def publish(self, topic, payload):
        if self.state == MqttClient.Connected:
            self.m_client.publish(topic, payload)
    #################################################################
    # callbacks
